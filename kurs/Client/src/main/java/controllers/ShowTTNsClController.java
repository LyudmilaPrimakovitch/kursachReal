...
public class ShowTTNsClController implements Initializable {
    @FXML
    ...
    @FXML
    private TableColumn<TTNs, String> prodTypeCol;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        prodTypeCol.setCellValueFactory(field -> new SimpleObjectProperty<>(field.getValue().getTypeProduct()));
